...
<a style="margin-bottom:10px;margin-left:2px; background-color:gray; border-color:gray" href="laporankorelasi.php?no=<?php echo $noderr;?>" class="btn btn-primary" ><span></span>Laporan Korelasi</a>
	<h3>Detail Laporan Korelasi</h3>
</center>
<table class=" col-md-12 table table-hover" >
		<tr>
			<td style="background-color:skyblue;"><center><label class="control-label">Standar</label></center></td>
			<td style="background-color:skyblue;"><center><label class="control-label">Rata-Rata Alat</label></center></td>
			<td style="background-color:skyblue;"> <center><label class="control-label">Korelasi</label></center></td>
		</tr>
<?php
...
?>
		...
		<tr>
			...
			<td><center><?php echo $d['rata2']; ?></center></td>
			<td><center><?php echo $d['korelasi']; ?></center></td>			
		</tr>		
