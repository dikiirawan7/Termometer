<?php
	include 'awal.php';
		...
		//sampai nstt1
		$sql="select * from itermometer1 where noorder='$noder'";
		$check=mysqli_query($koneksi,$sql);
		$jumlah=$check->num_rows;
		
		if($jumlah==0){
		
		$sql1="insert into itermometer1 set noorder='$noder',setpoin='$point',s11='$s1',s12='$s2',s13='$s3',s14='$s4',s15='$s5',s16='$s6',t1='$t1',t2='$t2',t3='$t3',t4='$t4',t5='$t5',t6='$t6',s21='$s21',s22='$s22',s23='$s23',ktnt1='$ktnt1',
		ksts1='$ksts1',
		ksts2='$ksts2',
		nstt1='$nstt1',	
		pembt1='$pembt1',
		...
		$sql2="insert into bantuiter1 set noorder='$noder',
		point='$point',
		rts1='$rts1',
		rtt1='$rtt1',
		rts2='$rts2',
...
<form action="" method="POST" class="form-horizontal">
	...
	<div class="col-md-12">
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9">
			<input type="text" class="form-control" name="point" readonly  value="<?php echo $setalat['termo1'];?>" />
			</div>
			</div>
		</div>
	</div>
