<?php
	...
	$sql="select * from 
			bantuiter2
			inner join itermometer2 on itermometer2.noorder = bantuiter2.noorder
			inner join pelanggan on pelanggan.noorder = bantuiter2.noorder
			where bantuiter2.noorder = '$noderr'
			";
...
<center>
	...
	<h3>Detail Pengamatan Termometer 2</h3>
</center>
<?php
...
?>
	...
	<table class=" col-md-12 table table-hover">
		<tr>
			<td style="background-color:Green;"><center></center></td>
			<td style="background-color:Green;color:white;"><center><label class="control-label">S1</label></center></td>
			<td style="background-color:Green;color:white;"><center><label class="control-label">T1</label></center></td>
			<td style="background-color:Green;color:white;"> <center><label class="control-label">T2</label></center></td>
			<td style="background-color:Green;color:white;"><center><label class="control-label">S2</label></center></td>
		</tr>
		
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">1</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">2</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">3</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">4</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">5</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">6</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3" ><center><label class="control-label">Rata-Rata</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3" ><center><label class="control-label">Koreksi Titik Nol</label></center></td>
			<td><center></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3" ><center><label class="control-label">Koreksi Standar</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3" ><center><label class="control-label">Hasil Terkoreksi</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3" ><center><label class="control-label">Koreksi Penunjukkan</label></center></td>
			<td><center></center></td>
		...
		<tr>
			<td style="background-color:Green;" class="col-md-3" colspan="5"><center><label class="control-label"></label></center></td>
		</tr>
	...
	<table class=" col-md-12 table table-hover" >
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Standar Deviasi</label></center></td>
			<td><center></center></td>
			<td><center><?php echo number_format($d['stdevt1'],3); ?></center></td>
			<td><center></center></td>
		</tr>
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Pembagi</label></center></td>
			<td><center></center></td>
			<td><center><?php echo number_format($d['pembt1sqrt'],3); ?></center></td>
			<td><center></center></td>
		</tr>
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Nilai Skala Terkecil</label></center></td>
			<td><center></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Ketidakpastian Standar</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Ketidakpastian Media</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Ketidakpastian Titik Es</label></center></td>
		...
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Ketidakpastian Gabungan</label></center></td>
			<td><center></center></td>
			<td><center><?php echo number_format($d['ktgbt1'],3); ?></center></td>
			<td><center></center></td>
		</tr>
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">faktor Cakupan</label></center></td>
			<td><center></center></td>
			<td><center><?php echo number_format($d['fct1'],3); ?></center></td>
			<td><center></center></td>
		</tr>
		<tr>
			<td style="background-color:Green;color:white;" class="col-md-3"><center><label class="control-label">Ketidakpastian Bentangan</label></center></td>
			<td><center></center></td>
			<td><center><?php echo number_format($d['ktbet1'],3); ?></center></td>
			<td><center></center></td>
		</tr>
		<tr>
			<td style="background-color:Green;" class="col-md-3" colspan="4"><center><label class="control-label"></label></center></td>
		</tr>
