<?php
	include 'awal.php';
		...
		//sampai nstt1
		$sql="select * from itermometer5 where noorder='$noder'";
		$check=mysqli_query($koneksi,$sql);
		$jumlah=$check->num_rows;
		
		if($jumlah==0){
		
		$sql1="insert into itermometer5 set noorder='$noder',setpoin='$point',s11='$s1',s12='$s2',s13='$s3',s14='$s4',s15='$s5',s16='$s6',t1='$t1',t2='$t2',t3='$t3',t4='$t4',t5='$t5',t6='$t6',s21='$s21',s22='$s22',s23='$s23',ktnt1='$ktnt1',
		ksts1='$ksts1',
		ksts2='$ksts2',
		nstt1='$nstt1',	
		pembt1='$pembt1',
		...
		$sql2="insert into bantuiter5 set noorder='$noder',
		point='$point',
		rts1='$rts1',
		rtt1='$rtt1',
		rts2='$rts2',
...
<form action="" method="POST" class="form-horizontal">
	...
	<div class="col-md-12">
		...
		<div class="col-md-6">
			...
			<div class="col-sm-9">
			<input type="text" class="form-control" name="point"   readonly value="<?php echo $setalat['termo5'];?>" />
			</div>
			</div>
		</div>
	</div>
	
	<table class="col-md-12" style="border-color:#DAB96B; color:black;" >
		<tr>
		...
		<tr>
			<td style="background-color:#DAB96B;" class="col-md-3" ><center><label class="control-label">Pembagi Nilai Skala Terkecil</label></center></td>
			<td><center><input type="text" class="form-control" style="border-radius:0px;" readonly name="pemilik" required  /></center></td>
		...
		<tr>
			<td style="background-color:#DAB96B;" class="col-md-3" ><center><label class="control-label">Pembagi Ketidakpastian Media</label></center></td>
		...
		<tr>
			<td style="background-color:#DAB96B;" class="col-md-3" ><center><label class="control-label">Pembagi Titik ES</label></center></td>
			<td><center><input type="text" class="form-control" style="border-radius:0px;" readonly name="pemilik"  required /></center></td>
