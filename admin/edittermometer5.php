<?php
	include 'awal.php';
		...
		$sql1=" update itermometer5 set setpoin='$point',s11='$s1',s12='$s2',s13='$s3',s14='$s4',s15='$s5',s16='$s6',t1='$t1',t2='$t2',t3='$t3',t4='$t4',t5='$t5',t6='$t6',s21='$s21',s22='$s22',s23='$s23',ktnt1='$ktnt1',
		ksts1='$ksts1',
		ksts2='$ksts2',
		nstt1='$nstt1',	
		pembt1='$pembt1',
...
<h3>Edit Pengamatan Termometer 5</h3>
</center>
<?php


$det=mysqli_query($koneksi,"select * from itermometer5 where noorder='$noderr'")or die(mysql_error());
...
<form action="" method="POST" class="form-horizontal">
	...
	<table class="col-md-12" style="border-color:#DAB96B;" >
		<tr>
