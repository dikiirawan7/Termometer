<?php
	...
	$sql="select * from 
			bantuiter1
			inner join itermometer1 on itermometer1.noorder = bantuiter1.noorder
			inner join pelanggan on pelanggan.noorder = bantuiter1.noorder
			where bantuiter1.noorder = '$noderr'
			";
...
<center>
	...
	<h3>Detail Pengamatan Termometer 1</h3>
</center>
<?php
...
?>
	...
	<table class=" col-md-12 table table-hover" >
		...
		<tr>
			<td style="background-color:skyblue;" class="col-md-3" ><center><label class="control-label">Rata-Rata</label></center></td>
		...
		<tr>
			<td style="background-color:skyblue;" class="col-md-3" ><center><label class="control-label">Hasil Terkoreksi</label></center></td>
		...
		<tr>
			<td style="background-color:skyblue;" class="col-md-3" ><center><label class="control-label">Koreksi Penunjukkan</label></center></td>
			<td><center></center></td>
	...
	<table class=" col-md-12 table table-hover" >
		...
		<tr>
			<td style="background-color:skyblue;" class="col-md-3"><center><label class="control-label">Standar Deviasi</label></center></td>
			<td><center></center></td>
		...
		<tr>
			<td style="background-color:skyblue;" class="col-md-3"><center><label class="control-label">Ketidakpastian Gabungan</label></center></td>
			<td><center></center></td>
		...
		<tr>
			<td style="background-color:skyblue;" class="col-md-3"><center><label class="control-label">Ketidakpastian Bentangan</label></center></td>
			<td><center></center></td>
			<td><center><?php echo number_format($d['ktbet1'],3); ?></center></td>
			<td><center></center></td>
		</tr>
		<tr>
			<td style="background-color:skyblue;" class="col-md-3" colspan="4"><center><label class="control-label"></label></center></td>
		</tr>
